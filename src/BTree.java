...
public class BTree {
  ...
  public BTree(RandomAccessFile file, String tableName) {
    ...
    try {
      ...
      if (!tableName.equals(DavisBase.masterColumnTableName) && !tableName.equals(DavisBase.masterTableName)) {
        mDBColumnFiletree = new BTree(new RandomAccessFile(Utils.getFilePath("master", DavisBase.masterColumnTableName), "rw"), DavisBase.masterColumnTableName,
            true, false);
  ...
  public LinkedHashMap<String, ArrayList<String>> searchWithPrimaryKey(LinkedHashMap<String, ArrayList<String>> token) {
    ...
    LinkedHashMap<String, ArrayList<String>> value = new LinkedHashMap<String, ArrayList<String>>();
